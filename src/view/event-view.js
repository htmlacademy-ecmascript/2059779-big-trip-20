...
function createEventViewTemplate(event) {
  ...
  return (/*html*/
    `<li class="trip-events__item">
        <div class="event">
          <time class="event__date" datetime="${dateTimeAttribute}">MAR 18</time>
          ...
          <div class="event__schedule">
            ...
            <p class="event__duration">${getDateDiff(dateTo, dateFrom)}M</p>
          </div>
