...
function createTripInfoTemplate(events, totalPrice, tripTitle) {
...
export default class TripInfoView extends AbstractView {
  ...
  constructor({ events, totalPrice, tripTitle }) {
    super();
    this.#events = events;
  ...
  get template() {
    return createTripInfoTemplate(this.#events, this.#totalPrice, this.#tripTitle);
  }
}
